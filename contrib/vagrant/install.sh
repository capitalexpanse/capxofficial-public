...
mkdir -p ~/.capx
echo "rpcuser=username" >>~/.capx/capx.conf
echo "rpcpassword=`head -c 32 /dev/urandom | base64`" >>~/.capx/capx.conf

#    git clone https://github.com/capx/capx
#    cd capx
#    git checkout v0.6.1cpx
#    qmake -qt=qt5 && make
