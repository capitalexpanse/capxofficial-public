...
// capxcoin: sync-checkpoint master key
...
// capxcoin: synchronized checkpoint (centrally broadcasted)
...
// capxcoin: get last synchronized checkpoint
...
// capxcoin: only descendant of current sync-checkpoint is allowed
...
// capxcoin: reset synchronized checkpoint to last hardened checkpoint
...
// capxcoin: find block wanted by given orphan block
...
// capxcoin: verify signature of sync-checkpoint message
...
// capxcoin: process synchronized checkpoint
...
// get information of sync-checkpoint (first introduced in capxcoin)
