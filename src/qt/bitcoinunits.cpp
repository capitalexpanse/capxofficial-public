...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("CPX");
    case mBTC: return QString("mCPX");
    case uBTC: return QString::fromUtf8("μCPX");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("CapXs");
    case mBTC: return QString("Milli-CapXs (1 / 1,000)");
    case uBTC: return QString("Micro-CapXs (1 / 1,000,000)");
    default: return QString("???");
    }
}
