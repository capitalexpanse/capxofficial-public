...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "CapX " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seedcapx", "seed.capx.net"},
    {"seed", "seed.capxcoin.net"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"tseedcapx", "tseed.capx.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. CapX is probably already running."), addrBind.ToString().c_str());
        else
