 ...
 * capxcoin public-key-hash-addresses have version 55 (or 111 testnet).
...
public:
    enum
    {
        PUBKEY_ADDRESS = 55,  // capxcoin: addresses begin with 'P'
        SCRIPT_ADDRESS = 117, // capxcoin: addresses begin with 'p'
