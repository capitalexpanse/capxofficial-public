...
// capxcoin: remove transaction from mempool
...
// capxcoin: reserve balance from being staked for network protection
...
// capxcoin: check wallet integrity
...
void StartRPCThreads()
{
        ...
        (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use capxd";
